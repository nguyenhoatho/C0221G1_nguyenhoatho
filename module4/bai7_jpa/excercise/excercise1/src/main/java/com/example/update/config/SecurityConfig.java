...
import com.example.update.model.service.impl.UserService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/","blog/view","blog/delete").access("hasAnyRole('ROLE_USER', 'ROLE_ADMIN')");

        // Trang chỉ dành cho ADMIN
        http.authorizeRequests().antMatchers("/listCategory","/createCategory","/createCategory","/category/edit",
                "/category/view","/category/delete").access("hasRole('ROLE_ADMIN')");

...
select  hd.id_hop_dong,hd.ngay_hop_dong,hd.ngay_ket_thuc,hd.tien_dat_coc,hdct.so_luong,count(hdct.id_hop_dong_chi_tiet) as "so_luong_hop_dong"
...
month(hd.ngay_hop_dong) not in (1,2,3,4,5,6) and month(hd.ngay_hop_dong) in (10,11,12)

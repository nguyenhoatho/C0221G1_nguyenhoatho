        ...
        <div class=" row">
            ...
            <div class="col-lg-8 bg-info">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-lg-9">
                        <input  type="text" name="positionID" value="${employee.positionID}">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input  type="text" name="educationDegreeID" value="${employee.educationDegreeID}">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input  type="text" name="divisionID" value="${employee.divisionID}">
                    </div>
                </div>

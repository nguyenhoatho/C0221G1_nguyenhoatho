        ...
        <div class=" row">
            ...
            <div class="col-lg-8 bg-info">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerName" value="${customer.customerName}">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerBirthday" value="${customer.customerBirthday}">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerGender" value="${customer.customerGender}">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerIDCard" value="${customer.customerIDCard}">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerPhone" value="${customer.customerPhone}">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerEmail" value="${customer.customerEmail}">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerAddress" value="${customer.customerAddress}">
                    </div>
                </div>
                <div class="row p-2 align-items-center">
                    <div class="col-lg-5 col-md-4 col-sm-4 "></div>
                    <div class="col-lg-2 col-md-4 col-sm-4 ">
                        <input class="btn btn-success" type="submit" id="submit" value="Delete Customer" style="width: 200px">
                    </div>

        ...
        <div class=" row">
            ...
            <div class="col-lg-8 bg-info">
                ...
                <div class="row p-2 pt-5">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="contractID">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly  type="text" name="contractStartDate">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="contractEndDate">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="contractDeposit">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="contractTotalMoney">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                ...
                <div class="row p-2 align-items-center">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-4 ">
                        <input class="btn btn-success" type="submit" id="submit" value="Delete Contract" style="width: 200px">
                    </div>

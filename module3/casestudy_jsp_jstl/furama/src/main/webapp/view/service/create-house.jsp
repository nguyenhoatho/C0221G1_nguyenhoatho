        ...
        <div class=" row">
            ...
            <div class="col-lg-8 bg-info">
                ...
                <div class="row p-2 ">
                    ...
                    <div class="col-lg-8">
                        <input class="w-25" type="text" name="serviceTypeID" value="House" readonly>
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-4 text-right">
                ...
                <div class="row p-2">
                    <div class="col-lg-4 text-right">
                        <label class="font-weight-bold">Description Other Convenience: </label>
                    </div>
                    <div class="col-lg-8">
                ...
                <div class="row p-2 justify-content-center pb-4">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 ">
                        <input class="btn btn-success" type="submit" id="submit" value="Create House"
                               style="width: 200px">
                    </div>

...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <h1 class="text-right"><a class="btn btn-success btnCreate ml-2" href="/employee?action=create">Create</a>
            </h1>
            <table class="table table-striped">
                ...
                <c:forEach items="${employees}" var="employee" varStatus="status">
                    <tr>
                        ...
                        <td><a class="btn btn-info" href="employee?action=view&employeeID=${employee.employeeID}">View</a>
                        </td>
                        <td><a class="btn btn-warning" href="employee?action=edit&employeeID=${employee.employeeID}">Edit</a>
                        </td>
                        <td><a class="btn btn-danger" href="employee?action=delete&employeeID=${employee.employeeID}">Delete</a>
                        </td>
